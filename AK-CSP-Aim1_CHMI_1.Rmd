...
Sub-data frames (w/ Log2 transform) -- NF54 and 7G8 CHMI -- parsed by Day1 or Day29 sera 
```{r}
# NF54 - parsed by Day1, Day29 sera
df_NF54_D1 <- cbind(LEFT_CSP, log(df_NF54[, col_NF54_D1], 2))
df_NF54_D29 <- cbind(LEFT_CSP, log(df_NF54[, col_NF54_D29], 2))

# 7G8 - parsed by Day1, Day29 sera
df_7G8_D1 <- cbind(LEFT_CSP, log(df_7G8[, col_7G8_D1], 2))
df_7G8_D29 <- cbind(LEFT_CSP, log(df_7G8[, col_7G8_D29], 2))
#print(df_NF54_D1)
```
...
# Obtain median COLUMN for using apply()
TestMedian_df_7G8_D29_values <- apply(df_7G8_D29[,col_7G8_D29], 2, median, na.rm = TRUE)
TestMedian_df_7G8_D29 <- names(df_7G8_D29[,col_7G8_D29])[which(TestMedian_df_7G8_D29_values == median(TestMedian_df_7G8_D29_values))]
...
plot7G8_D29_BP
```
Lineplot by position, no label
```{r} 
# Per 'Adjusted.Position'
df_7G8_D29_box <- melt(df_7G8_D29[,c(4, 5:ncol(df_7G8_D29))], id.vars = "Adjusted.Position")
plot7G8_D29_BP <- ggplot(df_7G8_D29_box, aes(x = Adjusted.Position, y = value)) + 
  geom_line(color="red") + 
  theme(axis.text.x = element_text(angle = 60, hjust = 1, size = 5)) +
  ggtitle("7G8_Day29")
plot7G8_D29_BP
```
MEDIAN Lineplot by position, no label
```{r} 
# Per 'Adjusted.Position'
df_7G8_D29_melt <- melt(df_7G8_D29[,c(4, 5:ncol(df_7G8_D29))], id.vars = "Adjusted.Position")
df_7G8_D29_median <- melt(df_7G8_D29[,c(4, which(colnames(df_7G8_D29)==TestMedian_df_7G8_D29))], id.vars = "Adjusted.Position")


plot7G8_D29_BP <- ggplot(df_7G8_D29_melt, aes(x = Adjusted.Position, y = value, group = variable)) + 
  geom_line(color="red", alpha = 0.1) + 
  geom_line(data = df_7G8_D29_median, color="red") + 
  theme(axis.text.x = element_text(angle = 60, hjust = 1, size = 5)) +
  ggtitle("7G8_Day29")
plot7G8_D29_BP
```
...
# Calculate median for using apply()
median_df_7G8_D21 <- apply(df_7G8_D1[,col_7G8_D1], 1, median, na.rm = TRUE)
```
